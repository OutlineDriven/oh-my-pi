...
export default class Index extends Command {
	...
	static flags = {
		...
		"approval-mode": Flags.string({
			options: ["always-ask", "write", "yolo", "heuristic", "guardian", "hybrid"],
			description: "Override tools.approvalMode for this session (always-ask|write|yolo|heuristic|guardian|hybrid)",
		}),
	};
