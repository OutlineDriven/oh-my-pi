...
// Critical bash patterns moved to a dependency-free leaf so the permission
// heuristic can reuse them without importing this module's full graph (tui,
// theme, exec, …). Re-exported here to keep the existing public symbol location.
export { CRITICAL_BASH_PATTERNS } from "./critical-bash-patterns";
